namespace BaseBackgroundJob.Api.Controllers.Features.V1.Products;

using Asp.Versioning;
using MediatR;
using Microsoft.AspNetCore.Mvc;

using BaseBackgroundJob.Application.Common.Exceptions;
using BaseBackgroundJob.Application.Common.Models;
using BaseBackgroundJob.Application.Features.V1.Products.Commands.CreateProduct;
using BaseBackgroundJob.Application.Features.V1.Products.Commands.UpdateProduct;
using BaseBackgroundJob.Application.Features.V1.Products.Commands.DeleteProduct;
using BaseBackgroundJob.Application.Features.V1.Products.Models.Responses;
using BaseBackgroundJob.Application.Features.V1.Products.Queries.GetProductById;
using BaseBackgroundJob.Application.Features.V1.Products.Queries.GetProducts;
